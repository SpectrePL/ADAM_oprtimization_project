...
def box(ax, cx, cy, w, h, fc, ec, line1, line2=None, line3=None, fs1=8.5, fs2=7, fs3=8):
    ...
    # Formatowanie dla 3 linijek (tekst + wzór w pętli)
    if line3:
...
# ── rząd 1: START → Konfiguracja → Wyzeruj ───────────────────────────────────
R1 = 7.9
...
# NIE — łuk precyzyjnie omijający bloki do góry, spadający na "Kolejny krok"
nie_x = C3 - DW/2
gap_x = 7.35 
...
# ── stopka ────────────────────────────────────────────────────────────────────
ax.plot([0.4, 10.6], [0.22, 0.22], color="#CFD8DC", lw=0.7)
ax.text(5.5, 0.1, "ADAM.py  •  funkcje.py  •  main.py",
        ha="center", va="center",
